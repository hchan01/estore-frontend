...
export const TermsAndConditionsScreen = () => (
    <div className="container">
        ...
        <p>We care about data privacy and security. Please review our <NavLink exact to='/privacy-policy'>Privacy Policy</NavLink> posted on the Site. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms and Conditions. Please be advised the Site is hosted in the United States.</p>
